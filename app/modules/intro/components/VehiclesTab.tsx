    ...
    <div className="space-y-4">
      <div className="bg-slate-50 border border-slate-200 rounded-xl p-5">
        <p className="text-slate-700 text-sm leading-relaxed">
          Not all contracts work the same way. The <strong>contract vehicle</strong> determines how work is competed, how task orders flow, and what it takes to get on — and stay on. Know the structure before you pursue. Vehicles marked <span className="bg-amber-400 text-amber-900 text-xs font-black px-1.5 py-0.5 rounded">KDT PRIORITY</span> are the realistic on-ramp sequence for a new contractor.
        </p>
      </div>
